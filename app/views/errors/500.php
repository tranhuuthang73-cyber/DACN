...
<head>
    ...
    <title>500 - Lỗi máy chủ | TravelGo</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .error-desc { color: #94A3B8; margin-bottom: 2rem; max-width: 500px; line-height: 1.6; }
        .btn-home { 
...
<body>
    <div>
        ...
        <div class="error-title">Đã xảy ra lỗi hệ thống</div>
        <p class="error-desc">Hệ thống đang gặp sự cố tạm thời trong quá trình xử lý yêu cầu của bạn. Vui lòng thử lại sau giây lát.</p>
